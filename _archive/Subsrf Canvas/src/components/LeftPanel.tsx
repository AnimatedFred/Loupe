      ...
      <div className="p-2 border-b border-white/[0.06] flex-shrink-0">
        <div className="flex gap-1">
          <input
            ...
            className="flex-1 bg-surface border border-white/[0.08] rounded px-2 py-1 font-mono text-[9px] text-white/60 placeholder-white/20 outline-none focus:border-neon/30"
          />
          <button
            onClick={handleScan}
