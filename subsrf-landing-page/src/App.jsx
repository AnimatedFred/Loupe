  ...
  return (
    <>
      ...
      <main className="flex-grow pt-32 pb-4xl flex flex-col items-center w-full px-lg max-w-[1080px] mx-auto gap-4xl">
        ...
        {/* ── Get Started ── */}
        <section id="get-started" className="w-full flex flex-col gap-2xl pt-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-md">
            ...
            <div className="bg-layer border border-white-border p-lg rounded-DEFAULT flex flex-col gap-md">
              <div className="flex items-center gap-sm">
                <span className="font-mono-data text-[10px] text-neon bg-neon/10 border border-neon/20 px-sm py-xs rounded-DEFAULT">01</span>
                <span className="font-label-caps text-label-caps text-white-muted uppercase tracking-widest">Create account and login</span>
              </div>
              <p className="font-body text-body text-white-secondary">
                Sign in with Google to create your free account and access the Subsrf platform.
              </p>
              <div className="mt-auto">
                <button
                  onClick={onLogin}
                  className="flex items-center gap-sm bg-white-primary/10 border border-white-border text-white-primary px-md py-sm rounded-DEFAULT font-label-caps text-[11px] hover:bg-white-primary/20 transition-all active:scale-95"
                >
            ...
            <div className="bg-layer border border-white-border p-lg rounded-DEFAULT flex flex-col gap-md">
              <div className="flex items-center gap-sm">
                <span className="font-mono-data text-[10px] text-neon bg-neon/10 border border-neon/20 px-sm py-xs rounded-DEFAULT">02</span>
                <span className="font-label-caps text-label-caps text-white-muted uppercase tracking-widest">Chrome Extension</span>
              </div>
              <p className="font-body text-body text-white-secondary">
                For individual developers and designers who want AI-powered analysis.
              </p>
              <div className="mt-auto">
                <a
                  href="#"
                  className="inline-flex items-center gap-sm bg-neon text-void px-md py-sm rounded-DEFAULT font-label-caps text-[11px] hover:opacity-90 transition-opacity active:scale-95"
                >
            ...
            <div className="bg-layer border border-white-border p-lg rounded-DEFAULT flex flex-col gap-md">
              <div className="flex items-center gap-sm">
                <span className="font-mono-data text-[10px] text-neon bg-neon/10 border border-neon/20 px-sm py-xs rounded-DEFAULT">03</span>
                <span className="font-label-caps text-label-caps text-white-muted uppercase tracking-widest">Figma Plugin</span>
              </div>
              <p className="font-body text-body text-white-secondary">
                For power users and teams who need the full AI-to-canvas pipeline.
              </p>
              <div className="mt-auto">
                <a
                  href="#"
            ...
            <div className="bg-layer border border-white-border p-lg rounded-DEFAULT flex flex-col gap-md">
              <div className="flex items-center gap-sm">
                <span className="font-mono-data text-[10px] text-neon bg-neon/10 border border-neon/20 px-sm py-xs rounded-DEFAULT">04</span>
                <span className="font-label-caps text-label-caps text-white-muted uppercase tracking-widest">Connect MCP</span>
              </div>
              <p className="font-body text-body text-white-secondary">
                Add Figma Rest API and MCP server to Claude or Gemini.
              </p>
              <p className="font-mono-data text-[9px] text-white-muted mt-auto">*Only available on paid plans</p>
            </div>
          ...
          <div className="md:col-span-4 bg-layer border border-white-border rounded-lg p-lg flex flex-col gap-md relative">
            ...
            {subInfo?.periodEnd && (
              <div className="flex justify-between items-center py-sm border-t border-white-border">
                ...
                <span className="font-mono-data text-[13px] font-semibold text-neon">
