          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
            ...
            <div className="bg-layer border border-white-border p-lg rounded-DEFAULT flex flex-col gap-md">
              ...
              <div className="mt-auto">
                <button
                  onClick={onLogin}
                  className="flex items-center gap-sm bg-white text-void px-md py-sm rounded-DEFAULT font-label-caps text-[11px] hover:opacity-90 transition-opacity active:scale-95"
                >
