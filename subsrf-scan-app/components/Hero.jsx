  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        Point at any URL. Get the full token set, health score, component fingerprint, and AI critique — cleaned, named, and exported into any format your stack uses.
      </p>
      ...
      {tokens && !loading && (
        <div style={{
          ...
          {extractedUrl} scanned in {(extractionMs / 1000).toFixed(1)}s · {totalTokens} tokens found
        </div>
      )}
    </div>
  );
